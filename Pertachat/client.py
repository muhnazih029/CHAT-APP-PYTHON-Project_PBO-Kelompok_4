...
class ChatBox(Client):
    ...
    def display_image(self, image_path, sender):
        ...
        # img = tk.Label(self.chat_window, text=image_path, wraplength=200, bg=bg_color, bd=4, justify=img_direction, relief="flat", anchor="center")
        # self.add_message(f"Sent an image", sender)
    ...
    def show_emoji(self):
        for Emoji in self.emoji_data:
            ...
            self.emojis = self.emojis.resize((20, 20), Image.ANTIALIAS)
